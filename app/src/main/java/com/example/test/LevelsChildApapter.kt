...
class LevelsChildApapter(private var list: ArrayList<LevelsDetailsItems>,private val context: Context) : RecyclerView.Adapter<LevelsChildApapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvChild.text = level.name
        holder.tvWeight.text = level.weight.toString()
    }
    ...
    fun getItem(pos: Int): LevelsDetailsItems {
        return list[pos]
    }
    ...
    fun addItem(item: LevelsDetailsItems) {
        list.add(item)
